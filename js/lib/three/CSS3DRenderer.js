 ...
 *
 * unconed: allow dom elements to be passed in
 */
...
THREE.CSS3DRenderer = function (parameters) {
  ...
  var cameraElement = parameters.cameraElement || document.createElement( 'div' );
  var domElement = cameraElement.parentNode || document.createElement( 'div' );
  ...
  domElement.classList.add('css3d-frame');
  ...
  cameraElement.classList.add('css3d-camera');

  cameraElement.parentNode || domElement.appendChild( cameraElement );
